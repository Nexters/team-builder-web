<template>
    <div>
        <h1>Signup Form</h1>
        <form @submit.prevent="onSubmit" id="sign-up-form">
            ...
            <b-form-group label="Enter your password">
                <b-form-input v-validate="'required|min:6|max:14'" type="password" v-model="password" name="password"
                              placeholder="Password" ref="password"></b-form-input>
            </b-form-group>
            <b-form-group label="Enter your password again">
                <b-form-input v-validate="'required|confirmed:password'" type="password" v-model="confirmPassword"
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                signup(uid, password, position, role)
                    .then(res => {
